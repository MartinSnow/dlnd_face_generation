...
def discriminator(images, reuse=False, alpha=0.2):
    ...
    with tf.variable_scope('discriminator', reuse=reuse):
        ...
        # Flatten it
        width = int(relu3.shape[1])
        height = int(relu3.shape[2])
        channels = int(relu3.shape[3])
        # print('width:',width,type(width),'height:',height,'channels:',channels)
        flat = tf.reshape(relu3, (-1, width*height*channels))
